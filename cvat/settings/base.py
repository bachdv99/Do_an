...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '192.168.1.249,127.0.0.1').split(',')
...
NUCLIO = {
    ...
    'HOST': os.getenv('CVAT_NUCLIO_HOST', '192.168.1.249'),
...
CACHEOPS_REDIS = {
    'host': '192.168.1.249', # redis-server is on same machine
...
LOGGING = {
    ...
    'handlers': {
        ...
        'logstash': {
            ...
            'ssl_enable': False,
            'ssl_verify': False,
            'host': os.getenv('DJANGO_LOG_SERVER_HOST', '192.168.1.249'),
