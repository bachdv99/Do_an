...
- Open the installed Google Chrome browser and go to [192.168.1.249:8080](http://192.168.1.249:8080).
...
services:
  traefik:
    ...
    #   - traefik.http.routers.dashboard.rule=Host(`${CVAT_HOST:-192.168.1.249}`)
```
...
If you want to access your instance of CVAT outside of your 192.168.1.249 (on another domain),
