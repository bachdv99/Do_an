...
Let's see how it works in the UI. Go to the [models tab](http://192.168.1.249:8080/models)
...
After that, go to the [new task page](http://192.168.1.249:8080/tasks/create) and
...
Again, go to [models tab](http://192.168.1.249:8080/models) and check that you can
...
$ ssh -R 5678:192.168.1.249:5678 user@ipaddress
```

See how the latest command looks like in my case:

```console
root@2d6cceec8f70:/opt/nuclio# ssh -R 5678:192.168.1.249:5678 nmanovic@192.168.50.188
